    ...
    <div id="wrap">
        ...
        <div class="container">
            ...
            <div class="table table-fixed pg-width5 w-full px-4">
                <div class="mb-8">
                    <div class="text-size16 font-bold mb-6">入力カード情報</div>
                    <ul>
                        <li>
            ...
            <div class="px-4 mt-6 mb-12 mx-auto max-w-sm">
                <a href="credit_info_edt.php" class="block w-150 mx-auto border-solid border-gray-900 text-center border py-2 rounded text-size12">戻る</a>
            </div>
            <!--//買い物に戻る-->
        </div>
